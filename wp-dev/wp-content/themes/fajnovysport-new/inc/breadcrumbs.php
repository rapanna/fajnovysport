...
function breadcrumbs()
{
	...
	// Creating home link
	echo "<li class='breadcrumbs__item'><a href='" .
		get_home_url() .
		"' class='breadcrumbs__link'>" .
		$defaults["home"] .
		'</a><span aria-hidden="true">|</span></li>';
	...
	if (is_single()) {
		...
		if (!empty($category)) {
			...
			$get_parent_category = rtrim(
				get_category_parents($get_last_category->term_id, true, ","),
				","
			);
		...
		if (!empty($get_last_category)) {
			...
			echo "<li class='breadcrumbs__item breadcrumbs__item--current'><a href='#' class='breadcrumbs__link' aria-current='page'>" .
				get_the_title() .
				"</a></li>";
		} elseif (!empty($cat_id)) {
			echo "<li class='breadcrumbs__item'><a href='" .
		...
		$post_type = get_post_type();
		$post_type_object = get_post_type_object($post_type);
		echo "<li class='breadcrumbs__item breadcrumbs__item--current'>" .
			$post_type_object->labels->name .
			"</li>";
	} elseif (is_archive()) {
		// Taxonomy
