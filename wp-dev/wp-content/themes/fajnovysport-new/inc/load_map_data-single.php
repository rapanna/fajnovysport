        ...
        while($single_query->have_posts()){
            ...
            foreach($typsportu as $sport){
                ...
                if(empty($sport_image_name)){
                    $data->cathegories[$i++]= get_template_directory_uri()."/img/default_icon.png";
                } else {
                    $data->cathegories[$i++] = get_template_directory_uri()."/img/ikony-sportu/".$sport_image_name.".svg";
                }
            }
            ...
            //featured image
            $featuredImage =  get_the_post_thumbnail_url(get_the_id(),"cahtegory-thumbnail");
    ...
    foreach ($feateures as $sportoviste){
        ...
        if ($data_sportoviste['objectid'] ==  (int)$id){
            ...
            foreach($final_sports as $sport){
                ...
                if(empty($sport_image_name)){
                    $data->Data[$i]->cathegories[$j]= get_template_directory_uri()."/img/default_icon.png";
                } else {
                    $data->Data[$i]->cathegories[$j] = get_template_directory_uri()."/img/ikony-sportu/".$sport_image_name.".svg";
                }
                $sport_title= $sport->name;
